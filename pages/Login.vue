<template>
    <div class="flex justify-end" style="max-width: 1920px;">
        <div class="fixed top-0 left-0 w-screen h-screen bg-slate-50">
              <img :src="AuthImg" alt="logo">
        </div>
        <div class="flex justify-center items-center bg-gray-100 font-[sans-serif] h-full md:min-h-screen p-4 min-w-[700px]">
            <div class="grid justify-center max-w-md mx-auto">
                <form class="bg-white rounded-2xl p-6 relative z-10 shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)] min-w-[450px]">
                    <div class="mb-12">
                    ...
                    <div class="mt-12">
                        ...
                        <p class="text-sm text-center mt-6">Don't have an account <a href="javascript:void(0);"
