      ...
      <div class="flex items-center gap-5 max-lg:gap-4">
        ...
        <div class="flex items-center">
          <button
            ...
            class="relative inline-flex items-center text-sm font-medium text-center text-gray-500 hover:text-[#4880FF] focus:outline-none dark:hover:text-white dark:text-gray-400"
            type="button"
          >
            <svg
              class="w-5 h-5"
